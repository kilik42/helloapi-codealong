...
//lets us grap data from the body of Post
...
router.route('./vehicles')
   .post(function(req,res){
      ...
      vehicle.save(function(err){
        ...
        res.json({message: 'Vehicle was successful'});
      });
...
router.route('/vehicle/:vehicle_id')
 ...
 router.route('/vehicle/make/:make')
  .get(function(req, res){
    Vehcile.find({make: req.params.make}, function(err, vehicle){
      if (err){
        res.send(err);
      }
      res.json(vehicle);
...
// pritn friendly message to console
